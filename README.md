...
- [x] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
    ...
    I think React was made to simplify making a web page. It combines JS/CSS/HTML into one file (most of the time). Also by adding libraries of JS, it makes it so we dont have to reinvent the wheel when we write our own code. Working smarter not harder, which is more efficient.

- [x] What does it mean to _think_ in react?
    Think in components. Breaking the code down into components, or lots of small files that do 1 or 2 tasks makes it easier to debug. If something doesnt work, the errors can point you to the exact file.

- [x] Describe state.
    State refers to the data being used by your components.

- [x] Describe props.
    Props are the data between components. You can pass them between them or use them locally. Took me the while week to learn "props" meant "properties". lol
